    ...
    if st.session_state.user is None:
        if st.session_state.recovery_mode:
            ...
            with tab_login:
                ...
                # 2. Entramos a la columna del botón de ingreso
                with col_login:
                    if st.button("Entrar", use_container_width=True):
                        ...
                        if res:
                            ...
                            try:
                                ...
                                # se ignora el error de forma segura. El st.session_state.user ya está asignado.
                                pass
                
                            st.rerun()
        
                # 3. Entramos a la columna del botón de soporte/olvido
                with col_olvido:
